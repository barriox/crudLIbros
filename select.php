...
if ($resultado->num_rows === 0) {
    ...
    echo "<h1>LIBRO</h1>";
    echo "El libro que has seleccionado es: ".$libro['titulo']."<br>";
    echo "Tiene el numero de ID: ".$libro['libroID']."<br>";
    echo "Está colocado en la estanteria número: ".$libro['estanteriaID']."<br>";
    echo "<button><a href='update.php?libroID=".$libro['libroID']."'>Editar</a></button><button><a href='delete.php?libroID=".$libro['libroID']."'>Borrar</a></button>";
